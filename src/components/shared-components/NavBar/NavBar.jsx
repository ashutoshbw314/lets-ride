        ...
        <div className={`${verticalMenu ? '' : 'hidden '} w-full lg:flex lg:items-center lg:w-auto`}>
          <nav>
            <ul className='items-center justify-between text-base text-gray-800 lg:flex lg:pt-0'>
              ...
              <li><Link className='block px-0 py-3 border-b-2 border-transparent lg:border-b-4 lg:px-4 lg:py-2 hover:border-pink-600' to='/destination'>Destination</Link></li>
              <li><Link className='block px-0 py-3 border-b-2 border-transparent lg:border-b-4 lg:px-4 lg:py-2 hover:border-yellow-600' to='/blog'>Blog</Link></li>
              <li><Link className='block px-0 py-3 mb-2 border-b-2 border-transparent lg:border-b-4 lg:py-2 lg:px-4 hover:border-blue-600 lg:mb-0' to='/contact'>Contact</Link></li>
            </ul>
          </nav>
          {
            auth?.user &&
